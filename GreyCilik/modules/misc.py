...
❖ /video atau /vsong (pencarian): unduh video dari youtube
❖ /music atau /song (pencarian): download lagu dari server youtube. (BERBASIS API)
❖ /lyrics (judul lagu) : Plugin ini mencari lirik lagu dengan nama lagu.
"""
